...
#define __VECTORS_H     1
    ...
    #define VECTOR_061      UART0_IRQHandler// 0x0000_00F4 61    45     UART0            Single interrupt vector for UART status sources
    #define VECTOR_062      default_isr     // 0x0000_00F8 62    46     UART0            Single interrupt vector for UART error sources
    #define VECTOR_063      UART1_IRQHandler// 0x0000_00FC 63    47     UART1            Single interrupt vector for UART status sources
    #define VECTOR_064      default_isr     // 0x0000_0100 64    48     UART1            Single interrupt vector for UART error sources
    #define VECTOR_065      UART2_IRQHandler// 0x0000_0104 65    49     UART2            Single interrupt vector for UART status sources
    #define VECTOR_066      default_isr     // 0x0000_0108 66    50     UART2            Single interrupt vector for UART error sources
    #define VECTOR_067      UART3_IRQHandler// 0x0000_010C 67    51     UART3            Single interrupt vector for UART status sources
    #define VECTOR_068      default_isr     // 0x0000_0110 68    52     UART3            Single interrupt vector for UART error sources
    #define VECTOR_069      UART4_IRQHandler// 0x0000_0114 69    53     UART4            Single interrupt vector for UART status sources
    #define VECTOR_070      default_isr     // 0x0000_0118 70    54     UART4            Single interrupt vector for UART error sources
    #define VECTOR_071      UART5_IRQHandler// 0x0000_011C 71    55     UART5            Single interrupt vector for UART status sources
    ...
    #define VECTOR_078      FTM0_interrupt     // 0x0000_0138 78    62     FTM0 			 Single interrupt vector for all sources
    #define VECTOR_079      FTM1_interrupt     // 0x0000_013C 79    63     FTM1 			 Single interrupt vector for all sources
    #define VECTOR_080      FTM2_interrupt     // 0x0000_0140 80    64     FTM2 			 Single interrupt vector for all sources
    ...
    #define VECTOR_084      PIT0_Interrupt     // 0x0000_0150 84    68     PIT Channel 0
    #define VECTOR_085      PIT1_Interrupt     // 0x0000_0154 85    69     PIT Channel 1
    #define VECTOR_086      PIT2_Interrupt     // 0x0000_0158 86    70     PIT Channel 2
    #define VECTOR_087      PIT3_Interrupt     // 0x0000_015C 87    71     PIT Channel 3
    ...
    #define VECTOR_101      LPTMR_Interrupt // 0x0000_0194 101   85     Low Power Timer
    #define VECTOR_102      default_isr     // 0x0000_0198 102   86     Segment LCD 	 Single interrupt vector for all sources
    #define VECTOR_103      PORTA_Interrupt     // 0x0000_019C 103   87     Port control module Pin Detect (Port A)
    #define VECTOR_104      PORTB_Interrupt     // 0x0000_01A0 104   88     Port control module Pin Detect (Port B)
    #define VECTOR_105      PORTC_Interrupt     // 0x0000_01A4 105   89     Port control module Pin Detect (Port C)
    #define VECTOR_106      PORTD_Interrupt     // 0x0000_01A8 106   90     Port control module Pin Detect (Port D)
    #define VECTOR_107      PORTE_Interrupt     // 0x0000_01AC 107   91     Port control module Pin Detect (Port E)
